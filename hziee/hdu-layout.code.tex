...
\RequirePackage
  [ skip = 1.75ex, labelsep = quad, font = footnotesize ]{caption}
\fancyhf{}
\pagestyle{fancy}
...
\cs_set_protected_nopar:Nn \__hdu_docinfo_process_aux:
  {
    ...
    \tl_set:Nn \l__hdu_set_cnsupervisor_tl { \l__hdu_set_supervisor_tl }
    \tl_clear:N \l__hdu_set_cnrole_tl
    \tl_clear:N \l__hdu_set_enrole_tl
    \tl_clear:N \l__hdu_set_ensupervisor_tl
