...
\fancyhead[C]
  {
    \raisebox { .12ex }
      { \small 杭州电子科技大学信息工程学院本科毕业设计 }
  }
\hook_gput_code:nnn {cmd/tableofcontents/before} { . }
  {
    \clearpage
    \pagenumbering{Roman} \cfoot{}
  }
\hook_gput_code:nnn { cmd/tableofcontents/after } { . }
  {
    \thispagestyle{fancy} \clearpage
    \pagenumbering{arabic} \cfoot{\fontsize{9pt}{9pt}\selectfont\songti\thepage}
  }
...
\cs_new_protected_nopar:Nn \__hdu_maketitle_bc_auxi:
  {
    \begin{center}
      \vspace*{14\p@}
      {\fontsize{28pt}{28pt}\selectfont\songti \textbf { 杭州电子科技大学信息工程学院} }
      \par \vspace*{36\p@}
      \scalebox{2.75}
      {
        \textbf { 本科毕业设计 }
...
\ctexset
  {
    chapter    =
      {
        fixskip = true, name = {},  beforeskip = 2\baselineskip,
        format+ = \sffamily \Large \centering, afterskip  = 2\baselineskip,
        number  = \arabic{chapter}, pagestyle  = fancy,
      },
    section    =
      {
        beforeskip = 1.25ex, fixskip = true,
        afterskip  = 1.5ex,  format  = \sffamily \large \raggedright
      },
    subsection =
      {
        beforeskip = 1.25ex, fixskip = true,
